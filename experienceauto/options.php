...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'desc' => __('Add header logo.', 'options_check'),
		'id' => 'header_logo',
		'class' => 'example_uploader',
		'type' => 'upload'
	);
	$options[] = array(
		'name' => __('Privacy Policy Link', 'options_check'),
		'desc' => __('Privacy Policy page link to add in the footer', 'options_check'),
	...
	$options[] = array(
		'name' => __('Terms and Conditions', 'options_check'),
		'desc' => __('Terms and Conditions page link to add in the footer', 'options_check'),
	...
	$options[] = array(
		...
		'desc' => __('Add number without spaces and dashes', 'options_check'),
		'id' => 'whatsapp_link',
		'std' => '',
		'class' => 'mini',
		'type' => 'text'
